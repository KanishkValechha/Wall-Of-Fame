...
export default function TeamModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className=" max-h-[90vh] w-[calc(100%-4rem)] max-w-4xl mx-auto overflow-y-auto bg-linear-to-b from-white/95 to-white/90 backdrop-blur-md pt-6 md:p-8 rounded-lg border-0">
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="card-shine bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:shadow-xl">
                  ...
                  <div className="p-2 sm:p-3 bg-linear-to-b from-transparent to-white/95">
